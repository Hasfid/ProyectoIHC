...
export default function Scanner() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      setPhase('uploading');
      const mimeType = previewUri.includes('video') || previewUri.includes('.mp4') ? 'video/mp4' : 'image/jpeg';
    ...
    <View style={styles.container}>
      ...
      {phase === 'idle' && (
        <View style={styles.idleView}>
          ...
          <Text style={styles.subtitle}>Sube una foto o video para que la IA identifique la especie en la Guayana.</Text>
...
const styles = StyleSheet.create({
  ...
  uploadBtn: { width: 300, height: 200, backgroundColor: '#fff', borderRadius: 24, justifyContent: 'center', alignItems: 'center', gap: 12, borderWeight: 2, borderColor: '#004d40', borderStyle: 'dashed', borderWidth: 2 },
